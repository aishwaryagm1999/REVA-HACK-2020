...
<body>
  <div class="row">
    <div class="col-sm-12">
      <div class="well">
        <center><h1 style="color: white;">Pixaloris</h1></center>
      </div>
    </div>
  </div>
  <div class="row">
    <div class="col-sm-6" style="left:0.5%;">
      <img src="images/dslr.jpeg" class="img-rounded" title="Coding cafe" width="650px" height="565px">
    ...
    <div class="col-sm-6" style="left:8%:">
      <img src="images/logo.png" class="img-rounded" title="pixaloris" width="80px" height="80px">
      <h2 style='color:white;'><strong>Discover Photographers across <br> the world now</strong></h2><br><br>
      <h4 style='color:white;'><strong>Join the Pixalorians now !</strong></h4>
